(function (Vue) {
    ...
    const modal = e.origin.$modal({
      render: function(createElement) {
        ...
        return createElement('div', {
          ...
          attrs: {
            src: Vue.url('administrator/index.php?option=com_fourtexx&view=seminars&tmpl=component', {
  ...
  Vue.events.on('resolveItemTitle', function (e, module) {
    ...
    if (e.origin.field.module !== 'seminar') {
      return;
    }

    e.stopPropagation();

    return e.origin.$http.get('seminar/seminars', {params: {ids: [module.id]}}).then(function(response) {
