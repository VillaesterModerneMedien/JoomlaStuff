(function (Vue) {
    ...
    const modal = e.origin.$modal({
      render: function(createElement) {
        ...
        return createElement('div', {
          ...
          attrs: {
            src: Vue.url('administrator/index.php?option=com_sercosysmia&view=vehicles&layout=modal&tmpl=component', {
  ...
  Vue.events.on('resolveItemTitle', function (e, module) {
    ...
    if (e.origin.field.module !== 'vehicle') {
      return;
    }

    e.stopPropagation();

    return e.origin.$http.get('vehicle/vehicles', {params: {ids: [module.id]}}).then(function(response) {
